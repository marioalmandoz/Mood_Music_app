 ...
 */
export declare function parseErrors(results: ResponsePayloads): HueError[] | undefined;
/**
 ...
 */
export declare function wasSuccessful(result: ResponsePayloads): boolean;
export declare function extractUpdatedAttributes(result: ResponsePayloads): KeyValueType;
export declare function deprecatedFunction(version: string, func: string, message: string): void;
export {};
