...
exports.ZLLRelativeRotary = void 0;
...
const STATE_ATTRIBUTES = [
    new types_1.Int16Type({ name: 'rotaryevent' }),
    new types_1.Int16Type({ name: 'expectedrotation' }),
    new types_1.Int16Type({ name: 'expectedeventduration' }),
];
// Hue Tap Dial Switch
class ZLLRelativeRotary extends Sensor_1.Sensor {
    constructor(id) {
...
exports.ZLLRelativeRotary = ZLLRelativeRotary;
